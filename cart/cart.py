...
class Cart:
    ...
    def __init__(self, request):
        ...
        if not cart:
            # сохранить пустую коризну в сеансе
    ...
    def __iter__(self):
        ...
        и получить товары из БД
        """
        products_ids = self.cart.keys()
        # получить объекты и добавить их в корзину
